<template>
  <div>
    ...
    <div :class="{ 'rtl': localeStore.isRTL }">
      ...
      <nav class="layout-bg px-4 py-2.5 fixed w-full top-0 start-0 z-30 border-b">
        <div class="flex flex-wrap justify-between items-center">
          <div class="flex items-center justify-start">
            <button @click="toggleSidebar" class="p-2 text-gray-200 flex items-center rounded-lg sm:hidden">
          ...
          <div class="flex items-center gap-2">
            <!-- RTL Toggle -->
            <button class="text-gray-200 rounded-lg text-sm p-2.5 me-1"
